...
RSpec.configure do |config|
    ...
    OmniAuth.config.mock_auth[:twitter] = OmniAuth::AuthHash.new({credentials: {token: '123456', secret: '123456'}, uid: '123456', provider: "Twitter", info: {email: "a@b.com", nickname: "Bookis"}})
    end
